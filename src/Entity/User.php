...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\Column]
    #[Assert\NotBlank(message: "Le champs Mot de passe ne peut pas être vide")]
    #[Assert\Regex(
        pattern: '/^(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/',
        message: "Le mot de passe doit contenir au moins une lettre majuscule, un chiffre, un caractère spécial et avoir une longueur minimale de 8 caractères."
    )]
